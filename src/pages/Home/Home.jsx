                                ...
                                <li key={product.id} className="flex flex-col">
                                    <article className="flex h-full flex-col">
                                        ...
                                        <div className="mt-4 flex items-center justify-between gap-3">
                                            ...
                                            <button
                                                type="button" onClick={() => addItem(product)}
                                                className="inline-flex items-center gap-2 rounded-full border border-[#ff7a1a] bg-white px-4 py-2 text-sm font-bold text-[#ff7a1a] transition hover:bg-[#fff3ea]"
                                            >
                                                <span>+</span>
                                                <span>Добавить</span>
                                            </button>
