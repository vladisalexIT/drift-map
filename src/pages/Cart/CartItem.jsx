...
export default function CartItem({ name, image, count, price }) {
  return (
    <div className="flex items-center justify-between border-t border-[#F4F4F4] py-8 w-full h-auto max-h-[624px] mx-auto">
      ...
      <div className="flex items-center gap-3">
        <button className="w-8 h-8 rounded-full border-2 border-[#FE5F1E] text-[#FE5F1E] flex items-center justify-center font-bold cursor-pointer">-</button>
