  ...
  return (
    <div className="my-10">
      ...
      <div className="flex justify-between items-center mt-10">
        <button className="flex items-center justify-center gap-2 px-7 py-4 border border-[#D3D3D3] rounded-full text-[#CACACA] hover:bg-[#f4f4f4] transition duration-300 cursor-pointer">
